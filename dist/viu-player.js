...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('core-js/modules/es.array.find-index'), require('core-js/modules/es.array.map'), require('core-js/modules/es.array.slice'), require('core-js/modules/es.array.splice'), require('core-js/modules/es.number.constructor'), require('core-js/modules/es.object.assign'), require('core-js/modules/es.object.keys'), require('core-js/modules/es.parse-int'), require('video.js'), require('core-js/modules/es.array.concat'), require('core-js/modules/es.array.for-each'), require('core-js/modules/web.dom-collections.for-each'), require('core-js/modules/es.array.filter'), require('core-js/modules/es.array.from'), require('core-js/modules/es.array.includes'), require('core-js/modules/es.string.includes'), require('core-js/modules/es.string.iterator')) :
  typeof define === 'function' && define.amd ? define(['core-js/modules/es.array.find-index', 'core-js/modules/es.array.map', 'core-js/modules/es.array.slice', 'core-js/modules/es.array.splice', 'core-js/modules/es.number.constructor', 'core-js/modules/es.object.assign', 'core-js/modules/es.object.keys', 'core-js/modules/es.parse-int', 'video.js', 'core-js/modules/es.array.concat', 'core-js/modules/es.array.for-each', 'core-js/modules/web.dom-collections.for-each', 'core-js/modules/es.array.filter', 'core-js/modules/es.array.from', 'core-js/modules/es.array.includes', 'core-js/modules/es.string.includes', 'core-js/modules/es.string.iterator'], factory) :
  (global = global || self, global.viuPlayer = factory(null, null, null, null, null, null, null, null, global.videojs));
}(this, (function (es_array_findIndex, es_array_map, es_array_slice, es_array_splice, es_number_constructor, es_object_assign, es_object_keys, es_parseInt, videojs) { 'use strict';
